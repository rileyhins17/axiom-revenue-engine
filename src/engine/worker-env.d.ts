/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.engine.jsonc --env-file=wrangler.typegen.env --env-interface=RevenueEngineEnv ./src/engine/worker-env.d.ts` (hash: 8fb28a75ae07c0b33dd976bd2f094454)
// Runtime types generated with workerd@1.20260923.1 2026-08-22 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_RevenueEngineEnv {
	ENGINE_ENVIRONMENT: "shadow";
	ENGINE_EXECUTION_ENABLED: "false";
	ENGINE_AUTONOMY_LEVEL: "OFF";
	ENGINE_MAX_JOB_COST_USD: "0";
	BUSINESS_WORKFLOW: Workflow<Parameters<import("./worker").RevenueBusinessWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
	}
	interface Env extends __BaseEnv_RevenueEngineEnv {}
}
interface RevenueEngineEnv extends __BaseEnv_RevenueEngineEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENGINE_ENVIRONMENT" | "ENGINE_EXECUTION_ENABLED" | "ENGINE_AUTONOMY_LEVEL" | "ENGINE_MAX_JOB_COST_USD">> {}
}
