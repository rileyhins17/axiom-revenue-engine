...
export function POST(request: Request) { return handleEngineCallerRequest(getDatabase() as unknown as CallerDb, request, 'stop',(getCloudflareBindings()??process.env),fetch,after); }
