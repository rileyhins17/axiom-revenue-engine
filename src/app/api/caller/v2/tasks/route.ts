...
export function GET(request: Request) { return handleEngineCallerRequest(getDatabase() as unknown as CallerDb, request, 'tasks',getCloudflareBindings()??process.env); }
