/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=wrangler.typegen.env --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: c729951a5514e7caa368c691c4fa47a4)
// Runtime types generated with workerd@1.20260923.1 2026-08-16 global_fetch_strictly_public,nodejs_compat,nodejs_compat_populate_process_env
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	BROWSER: BrowserRun;
	ASSETS: Fetcher;
	CALLER_V2_ENABLED: "false";
	CALLER_V2_WORKSPACE_ID: "axiom";
	CALLER_SYNC_ENABLED: "false";
	APP_BASE_URL: "https://axiom-revenue-engine-console-staging.aidan-magee2.workers.dev/" | "https://revenue.getaxiom.ca/";
	AUTH_ALLOWED_EMAILS: "aidan@getaxiom.ca,riley@getaxiom.ca";
	AUTH_ADMIN_EMAILS: "aidan@getaxiom.ca,riley@getaxiom.ca";
	AUTH_ALLOWED_ORIGINS: "https://axiom-revenue-engine-console-staging.aidan-magee2.workers.dev" | "https://axiom-revenue-engine-console.aidan-magee2.workers.dev,https://revenue.getaxiom.ca,https://operations.getaxiom.ca";
	...
	AUTONOMOUS_DOMAIN_COOLDOWN_DAYS: "14";
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		CALLER_V2_WORKSPACE_ID: "axiom";
		CALLER_SYNC_ENABLED: "false";
		APP_BASE_URL: "https://axiom-revenue-engine-console-staging.aidan-magee2.workers.dev/";
		AUTH_ALLOWED_EMAILS: "aidan@getaxiom.ca,riley@getaxiom.ca";
		AUTH_ADMIN_EMAILS: "aidan@getaxiom.ca,riley@getaxiom.ca";
		AUTH_ALLOWED_ORIGINS: "https://axiom-revenue-engine-console-staging.aidan-magee2.workers.dev";
		CLOUD_SCRAPE_ENABLED: "false";
		CLOUD_SCRAPE_TIMEOUT_MS: "840000";
		CLOUD_SCRAPE_WORKER_NAME: "cloudflare-browser";
		CLOUD_SCRAPE_DETAIL_PAGES_ENABLED: "false";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CALLER_V2_ENABLED" | "CALLER_V2_WORKSPACE_ID" | "CALLER_SYNC_ENABLED" | "APP_BASE_URL" | "AUTH_ALLOWED_EMAILS" | "AUTH_ADMIN_EMAILS" | "AUTH_ALLOWED_ORIGINS" | "CLOUD_SCRAPE_ENABLED" | "CLOUD_SCRAPE_TIMEOUT_MS" | "CLOUD_SCRAPE_WORKER_NAME" | "CLOUD_SCRAPE_DETAIL_PAGES_ENABLED" | "RATE_LIMIT_WINDOW_SECONDS" | "RATE_LIMIT_MAX_AUTH" | "RATE_LIMIT_MAX_SCRAPE" | "RATE_LIMIT_MAX_EXPORT" | "SCRAPE_CONCURRENCY_LIMIT" | "SCRAPE_TIMEOUT_MS" | "AUTONOMOUS_INTAKE_ENABLED" | "AUTONOMOUS_QUEUE_ENABLED" | "AUTONOMOUS_SEND_ENABLED" | "AUTONOMOUS_DAILY_LEAD_INTAKE_CAP" | "AUTONOMOUS_MAX_SENDS_PER_DAY" | "AUTONOMOUS_MAX_FOLLOW_UP_SENDS_PER_DAY" | "AUTONOMOUS_DOMAIN_COOLDOWN_DAYS">> {}
}
