...
forbidMatch("scripts/record-private-kw-shadow-progress.ts", privateKwShadowSliceProgressCli, /private-kw-contact-review-progress-proof|private-kw-contact-invocation-durable/, "the generic operator recorder must not import contact durable trust or proof construction");
forbidMatch("src/engine/worker.ts", engineWorker, /private-kw-contact-invocation-durable|private-kw-contact-review-progress-proof/, "the inert engine must not wire contact durable reload or progress proof to runtime");
