...
requireMatch("scripts/private-kw-database.ts", privateKwDatabase, /PRIVATE_KW_CANONICAL_MIGRATION_RANGE\s*=\s*"0054-0067"/, "ignored-local execution must require the complete migration 0067 schema");
